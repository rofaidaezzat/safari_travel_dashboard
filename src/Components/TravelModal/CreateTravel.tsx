...
import { useCreateTravelMutation, type Travel } from "../../app/services/crudTravel";
...
export function CreateTravelModal({ open, onClose }: CreateTravelModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createTravel(payload).unwrap();
      
      toast({
        title: "Request Sent",
        description: `Travel request for ${formData.fullname} created successfully.`,
      });
      ...
      toast({
        ...
        description: error?.data?.message || "Could not create travel request.",
      });
    }
  };
